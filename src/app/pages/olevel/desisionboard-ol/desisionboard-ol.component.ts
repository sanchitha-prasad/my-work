...
@Component(
    {selector: 'app-desisionboard-ol', templateUrl: './desisionboard-ol.component.html', styleUrls: ['./desisionboard-ol.component.css']}
)
