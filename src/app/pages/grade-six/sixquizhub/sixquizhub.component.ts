...
export class SixquizhubComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.Serviceservice.getquestionsix(ques).subscribe((event => {
      this.subQuiz = event;
    ...
    this.Serviceservice.levelbyQuestionsix(levlQuiz).subscribe((event => {
...
fifty(value): void {
  ...
  if ( this.getcoin <  4 ) {
    swal.queue([{
      ...
      text: 'you dont have enough coins. You need to least 4 coins to use this lifeline ',
      // icon: 'mood',
      // buttons: true,
      // dangerMode: true,
    }]);
...
skip(value): void {
  ...
  if ( this.getcoin < 2) {
    swal.queue([{
      title: 'Not Enough Coins..!!',
      text: 'you dont have enough coins. You need to least 2 coins to use this lifeline ',
      // icon: 'mood',
      // buttons: true,
      // dangerMode: true,
    }]);
